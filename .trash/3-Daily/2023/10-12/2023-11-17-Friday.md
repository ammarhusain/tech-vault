...
tags: 
---
**[DayOne](dayone://open?date=2023-11-17)**

# TOP-OF-MIND
- #journal/daily 
	- Worked to figure out a pet project over christmas break with a raspberry pi and local llama models + microcontroller -  [[tinkering]]
	- Tried to get notebook setup with whisper and audio to text transcription
	- Met up with Rathore for coffee at Starbucks in the evening
