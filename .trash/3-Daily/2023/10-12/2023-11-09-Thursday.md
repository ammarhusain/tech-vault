...
tags: 
---
**[DayOne](dayone://open?date=2023-11-09)**

# TOP-OF-MIND
- #j595/journal 
	- Andreas helped setup https://palazzo-eval.corp.apple.com using Shield nginx utility at Apple
		- [https://shield.corp.apple.com](https://shield.corp.apple.com/)
	- Worked with Comet team to get the experiments setup with url instead of IP address.
		- They support Oauth, LDAP etc for [SSO](https://apple:c62406846525b5d1ae388252e97eebc2@deployment-docs.comet.com/deployment-docs/deploying-comet/sso_integrations/okta/)
